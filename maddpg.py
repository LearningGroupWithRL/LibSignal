...
parser.add_argument('-a', '--agent', type=str, default="maddpg_v2", help="agent type of agents in RL environment")
parser.add_argument('-w', '--world', type=str, default="sumo", choices=['cityflow','sumo'], help="simulator type")
parser.add_argument('-n', '--network', type=str, default="jinan_3x4", help="network name")
